...
public class GetNFTInterfaceTest extends PlanetAutoConfigTestBase {
    ...
    public void getNFTTest() {
        ...
        // 4. 收集请求执行的区块链交易信息
        // 4.1. 查看请求关联的交易、收据
        ReceiptModel receipt = collectReceipt(getNFTRequest);
        TransactionModel transaction = collectTransaction(getNFTRequest);
        ...
        // 5. 检查请求是否成功
        assertTrue(
                getNFTResponse.getRespContext().getErrorMsg(),
                getNFTResponse.getRespContext().isSuccess());
    }
}
